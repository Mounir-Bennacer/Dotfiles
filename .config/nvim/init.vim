...
" ============================================================================
" .vimrc of Mounir Bennacer {{{
" ============================================================================
" Path to python and node
let g:python3_host_prog = expand('/usr/local/anaconda3/bin/python')
...
Plug 'junegunn/vim-github-dashboard'
  let g:github_dashboard = { 'username': 'mounir' }
...
" Lint
Plug 'w0rp/ale'
  let g:ale_linters = {'java': [], 'yaml': [], 'scala': [], 'clojure': [], 'go': ['gopls'],'python':[]}
  let g:ale_fixers = {'ruby': ['rubocop']}
  let g:ale_lint_delay = 1000
  nmap ]a <Plug>(ale_next_wrap)
  nmap [a <Plug>(ale_previous_wrap)

" PERSONAL ADDED VIM PLUGIN mounir
" TDD
Plug 'janko/vim-test' " https://github.com/vim-test/vim-test
...
"vim-journal xnoremap <leader>ht :Heytmux<cr>
...
function! s:syntax_include(lang, b, e, inclusive)
  let syns = split(globpath(&runtimepath, 'syntax/'.a:lang.".vim"), "\n")
  if empty(syns)
    return
  endif
...
function! s:setup_extra_keys()
  ...
  " gx
  nnoremap <buffer> <silent> gx :call <sid>pjustinmk/vim-dirvishlug_gx()<cr>
