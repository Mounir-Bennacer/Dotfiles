...
source ~/.config/nvim/keymapping/lightline.vim
source ~/.config/nvim/keymapping/keys.vim
source ~/.config/nvim/keymapping/signify.vim
source ~/.config/nvim/keymapping/startify.vim
source ~/.config/nvim/keymapping/fzf.vim
source ~/.config/nvim/keymapping/eslint.vim
source ~/.config/nvim/keymapping/neosnippet.vim
source ~/.config/nvim/keymapping/vimwiki.vim
